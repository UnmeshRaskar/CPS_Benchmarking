...
def crop_behavior_cow(cow_id, cam_id, subfolder, setting):
    ...
    image_folder = f"/nfs/hvvu2/ML/Data/2min_interval_images/cropped_bboxes/"
    # annotations_folder = f'/nfs/uraskar/Data/high_res/new2_16class_data/new_settings/setting_1/{subfolder}/labels'
    output_folder = f'/nfs/uraskar/Data/high_res/behaviour_detection/batch_4/cow_id_split'
    ...
    for index, row in filtered_df2.iterrows():
        ...
        # Hien's cropped file naming convention is different
        file_name = f"{timestamp_value_int}_{datetime_value_str}_{cam_id}.jpg"
        file_path = os.path.join(image_folder, (cow_id), file_name)
        # print(file_path)
        ...
        behavior_subfolder = os.path.join(output_folder, (cow_id), str(int(behavior)))
...
# Make sure the cows in here have their behavior csv files available
cows = ['01','02','03','04','05','06','07','08','09','10','11','12','14','15','16'] # 
cams = [1, 2, 3, 4]
settings = ['1'] #,'2','3','4','5'
